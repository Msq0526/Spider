...
var b = bi = function (e, k) {
    ...
    if (b['JgeLTy'] === undefined) {
        var F = function (Y) {
            ...
            var X = ''
                , q = '';
            for (var M = 0x212c * 0x1 + -0x19a5 + -0xacf + 840, p, z, D = 0x757 + -0x4a + -0x70d; z = Y['charAt'](D++); ~z && (p = M % (-0x53 * 0x5f + 0x39 * 0x33 + -0x1376 * -0x1) ? p * (0x204d + -0x139 * -0x3 + -0x2 * 0x1380 + 840) + z : z,
            M++ % (-0x7 * 0x204 + 0x1 * 0xed1 + -0xb1)) ? X += String['fromCharCode'](0x1b45 + -0x1 * -0x18fb + -0x3341 & p >> (-(-0x1a9f + -0x91c * 0x1 + -0x7 * -0x51b) * M & 0x526 + -0x106 * 0x6 + -0x74 * 0x5 + 840)) : -0x3 * -0x792 + -0x9 * -0x3f9 + -0x3a77) {
                z = (K['indexOf'](z) - (0x1c * 0x1c + -0x171f + 0x1416) + (-0x1f * -0x82 + -0x3c2 + -0x3e * 0x3e + 840)) % (-0x22aa + -0x767 + 0x2709 + 840);
            }
            for (var t = 0x1 * -0x18 + 0x4 * 0x615 + -0x183c, v = X['length']; t < v; t++) {
                q += '%' + ('00' + X['charCodeAt'](t)['toString'](0x4ab + -0xa79 * 0x1 + 0x1 * 0x296 + 840))['slice'](-(-0x1a41 + -0xc48 + -0x268b * -0x1));
            }
    ...
    var h = Z[-0x24b0 + -0x11e1 + 0x3349 + 840]
        , N = e + h
        , a = c[N];
...
Z = function (b6, b7) {
    var Yv = {
        ...
        , V9 = bi
        , b8 = {};
    b8[V9(1890)] = "DGi0YA7BemWnQjCl4+bR3f8SKIF9tUz/xhr2oEOgPpac=61ZqwTudLkM5vHyNXsVJ";
    var b9 = b8;
    return false ? '' : e(b6, 0x26d * 0x6 + 0x20bc + -0x328c + 840, function (bx) {
        var Vx = V9;
...
p = function (b7) {
    // var Zz = bi;   这块儿直接换成函数aa了
    for (var b8 = 0x1715 + -0x1 * 0x2456 + 0x9f9 + 840, b9 = -0x3 * 0x73f + -0xbe1 * 0x1 + -0xd * -0x296; bb(b9, b7['length']); b9++)
        b8 = aa(aa(aa(aa(b8, 0x1727 + 0x241c + -0x3e84 + 840), b8), -0x26a1 + 0x1d4d + -0xe * -0xc7), b7['charCodeAt'](b9)),
            b8 |= -0x224b + 0x2283 + 0x2 * -0x1c0 + 840;
    return b8;
}
...
var bV = aa(true),
    bV = aa(encodeURIComponent, bV);

b9 = aa(aa(aa(aa(aa(p(bV), '|'), 0), '|'), new Date()['getTime']()), '|1'),
    bV = Z(b9, !(0xff5 + 0x1301 + -0x263e * 0x1 + 840)),
    b9 = {};
