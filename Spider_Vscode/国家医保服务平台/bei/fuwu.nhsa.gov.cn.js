...
signData = function (t) {
    ...
    var a = sm2.doSignature(r, d, { hash: !0 });
...
encData = function (e) {
    ...
    var s = y(u, c);
    return l = b(s, a).toUpperCase().slice(0, 160)
}

decData = function (res) {
    var n = Buffer.from(res.data.data.encData, "hex");
    var t = y(u, c);
